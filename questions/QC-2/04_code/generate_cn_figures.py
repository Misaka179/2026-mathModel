...
plt.tight_layout()
plt.savefig('../06_figures/图1_成本分解.png', dpi=300, bbox_inches='tight')
print("  Saved: 图1_成本分解.png")
plt.close()
...
plt.tight_layout()
plt.savefig('../06_figures/图2_储能收益对比.png', dpi=300, bbox_inches='tight')
print("  Saved: 图2_储能收益对比.png")
plt.close()
...
plt.tight_layout()
plt.savefig('../06_figures/图3_低效成本分析.png', dpi=300, bbox_inches='tight')
print("  Saved: 图3_低效成本分析.png")
plt.close()
...
plt.tight_layout()
plt.savefig('../06_figures/图4_季节性分析.png', dpi=300, bbox_inches='tight')
print("  Saved: 图4_季节性分析.png")
plt.close()
...
plt.tight_layout()
plt.savefig('../06_figures/图5_SOC运行轨迹.png', dpi=300, bbox_inches='tight')
print("  Saved: 图5_SOC运行轨迹.png")
plt.close()

print("\n" + "="*60)
print("All Chinese figures completed!")
print("="*60)
