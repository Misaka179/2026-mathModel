...
# 图6: 跨日连续性验证
# ============================================================================
print("\nGenerating Figure 6: Cross-day Continuity Verification...")
...
plt.tight_layout()
plt.savefig('../06_figures/图6_跨日连续性验证.png', dpi=300, bbox_inches='tight')
print("  Saved: 图6_跨日连续性验证.png")
plt.close()

# ============================================================================
# 图7: 全年SOC轨迹
# ============================================================================
print("\nGenerating Figure 7: Full Year SOC Trajectory...")
...
plt.tight_layout()
plt.savefig('../06_figures/图7_全年SOC轨迹.png', dpi=300, bbox_inches='tight')
print("  Saved: 图7_全年SOC轨迹.png")
plt.close()

print("\n" + "="*60)
print("Supplementary figures completed!")
print("="*60)
print(f"\n生成的图表:")
